...
abstract: |
  Este documento presenta un análisis de validación y extensión de las tres clases latentes identificadas (Eco-modernismo reformista 60%, Conciencia crítica encerrada 13%, y Modernización ecológica redistributiva 27%) mediante su relación con tres ejes temáticos adicionales: (1) percepción de responsabilidad en la crisis ambiental, (2) consumo de carne y sustentabilidad, y (3) consumo digital y sustentabilidad. A través de análisis bivariados, modelos logísticos y comparaciones sistemáticas, se evalúa la coherencia entre el diagnóstico que cada clase hace de la crisis ambiental y su disposición a cambiar comportamientos concretos en alimentación y uso de Internet. Los resultados revelan tensiones significativas entre percepciones y prácticas, especialmente en relación con el consumo de carne, donde la brecha entre conciencia ambiental y disposición al cambio es más pronunciada que en el ámbito digital.
